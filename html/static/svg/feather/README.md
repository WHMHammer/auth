...
(the files under this directory are from [Feather](https://github.com/feathericons)'s [feather](https://github.com/feathericons/feather), [licence](https://github.com/feathericons/feather/blob/master/LICENSE)d by it.)
